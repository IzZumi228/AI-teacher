...
import { getUserCompanions, getUserSessions } from "@/lib/actions/companio.actions";
...
const Profile = async () => {
  ...
  return (
    <main className="min-lg:w-3/4 ">
      <section className="flex justify-between gap4 max-sm:flex-col items-center">
        <div className="flex gap-4 items-center">
          <Image src={user.imageUrl} alt={user.firstName || "User"} width={110} height={110} />
